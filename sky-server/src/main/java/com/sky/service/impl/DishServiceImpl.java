...
public class DishServiceImpl implements DishService {
    ...
    public List<Dish> queryByCategoryId(Integer categoryId) {
        return dishMapper.queryByDish(Dish.builder().categoryId(Long.valueOf(categoryId)).build());
    }
    ...
    public List<DishVO> listWithFlavor(Dish dish) {
        List<Dish> dishList = dishMapper.queryByDish(dish);
        ...
        for (Dish d : dishList) {
            ...
            //根据菜品id查询对应的口味
            List<DishFlavor> flavors = dishFlavorMapper.queryByDishId(Math.toIntExact(d.getId()));
